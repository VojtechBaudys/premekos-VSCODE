...
function activate(context) {
	...
	console.log('Congratulations, your extension "vscode-premekos" is now active!');

	// The command has been defined in the package.json file
	// Now provide the implementation of the command with  registerCommand
	// The commandId parameter must match the command field in package.json
	let disposable = vscode.commands.registerCommand('vscode-premekos.ptacci', function () {
	...
	vscode.commands.registerCommand('vscode-premekos.dotekomafie', function () {
		const panel = vscode.window.createWebviewPanel(
			'Dotekomafie',
			'Dotekomafie',
			vscode.ViewColumn.One,
		...
		panel.webview.html = dotekomafie();
	});

	vscode.commands.registerCommand('vscode-premekos.calcit', function () {
		const panel = vscode.window.createWebviewPanel(
			'Calcit',
			'Calcit',
			vscode.ViewColumn.One,
	...
	function calcit() {
		...
		<body>
			<iframe src="https://calcit.eu/" title="kalkul relacni"></iframe>
		</body>
		</html>`;
	}

	function dotekomafie() {
		return `<!DOCTYPE html>
		<html lang="en">
		<head>
			<meta charset="UTF-8">
			<meta name="viewport" content="width=device-width, initial-scale=1.0">
			<title>Dotekomafie</title>
		</head>
		<style>
			body {
				margin: 0;
		...
		<body>
			<iframe src="https://dotekomanie.cz/" title="mobilky"></iframe>
		</body>
		</html>`;
	}
